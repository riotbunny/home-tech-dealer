    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-fade-in">
      <div className="relative w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-slate-900 text-white px-6 py-5 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Carrier package &amp; pricing configuration</p>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 text-xs">
          ...
          <div>
            <label className="block text-slate-200 font-bold mb-1 uppercase tracking-wider text-[11px]">
              Admin Username
            </label>
            <input
              type="text"
              ...
              className="w-full px-3.5 py-2.5 bg-slate-950/50 border border-slate-700 rounded-xl text-white placeholder-slate-400 text-xs focus:outline-none focus:border-blue-600 font-medium"
            />
          </div>
          ...
          <div className="p-3 rounded-xl bg-indigo-900/30/60 border border-blue-100 flex items-start gap-2.5 text-[11px] text-blue-900">
          ...
          <div className="pt-2 flex items-center justify-end gap-2">
            <button
              type="button"
              onClick={onClose}
              className="px-4 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-800 text-slate-200 font-semibold"
            >
              Cancel
            </button>
