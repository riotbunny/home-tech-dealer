      ...
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-5 bg-white p-6 rounded-3xl border border-slate-200 shadow-sm space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            ...
            <span className="text-xs font-bold text-indigo-700 bg-blue-50 px-2 py-0.5 rounded-full">
              Interactive
            </span>
          </div>
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-xl border cursor-pointer flex items-start gap-3 transition-all ${
                    done ? 'bg-emerald-50 border-emerald-200 text-slate-600' : 'bg-slate-50/50 border-slate-200 text-slate-700 hover:bg-slate-100'
                  }`}
                >
