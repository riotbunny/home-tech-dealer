  ...
  return (
    <section className="relative overflow-hidden pt-10 sm:pt-16 pb-12 sm:pb-24">
      ...
      <div className="absolute top-0 left-0 right-0 h-full overflow-hidden -z-10 pointer-events-none">
        <div className="absolute -top-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-indigo-900/300/10 blur-[120px]"></div>
        <div className="absolute top-[20%] -right-[10%] w-[40%] h-[40%] rounded-full bg-indigo-900/300/10 blur-[100px]"></div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <div className="flex flex-col xs:flex-row sm:flex-row items-center justify-center sm:justify-start gap-3 mb-6">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900/60 backdrop-blur-md border border-slate-800/50 shadow-sm text-indigo-900 text-xs font-bold tracking-wide uppercase">
              ...
              <a
                href={telHref}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-900/300/10 hover:bg-emerald-900/300/20 border border-emerald-500/20 text-emerald-700 hover:text-emerald-800 text-xs font-bold transition-all shadow-sm"
              >
            ...
            <div className="text-center sm:text-left mb-8 sm:mb-10">
              <h1 className="text-4xl sm:text-5xl lg:text-[4rem] font-extrabold text-white tracking-tighter leading-[1.1] mb-5">
              ...
              <p className="text-base sm:text-lg text-slate-300/90 leading-relaxed max-w-lg font-medium">
                See every fiber, cable, 5G, and satellite plan available in{' '}
                <strong className="text-white font-bold">{hasValidCity ? (state ? `${formattedCityName}, ${state}` : `${formattedCityName} area`) : 'your area'}</strong>. 
                Compare speeds, exclusive pricing, and secure your mover reward cards.
              </p>
            </div>

            {/* Big Search Box (Glassmorphic) */}
            <div className="p-4 sm:p-6 rounded-[2rem] bg-slate-900/70 backdrop-blur-xl border border-slate-800 shadow-2xl shadow-indigo-900/10 transition-all hover:shadow-black/60">
              <div className="text-sm font-bold text-slate-100 mb-3 px-1 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                <span>
                  Enter your address in {hasValidCity ? formattedCityName : 'your area'}:
                </span>
                <button
                  onClick={onOpenSpeedQuiz}
                  className="text-indigo-600 hover:text-indigo-700 font-bold flex items-center gap-1.5 text-xs bg-indigo-900/30 hover:bg-indigo-100 px-3 py-1.5 rounded-full transition-colors"
                >
              ...
              {nearbyCities && nearbyCities.length > 0 && (
                <div className="mt-5 pt-4 border-t border-slate-800/60 flex items-center gap-2.5 overflow-x-auto pb-1 scrollbar-none text-xs">
                  <span className="text-xs font-bold text-slate-500 shrink-0 flex items-center gap-1.5 tracking-wider uppercase">
                  ...
                  {nearbyCities.map((cityItem, idx) => (
                    <button
                      ...
                      className="shrink-0 px-3 py-1.5 rounded-full bg-slate-800/80 hover:bg-indigo-900/30 hover:text-indigo-700 text-slate-200 font-bold text-xs transition-colors flex items-center gap-1.5 border border-slate-800/50"
                    >
        ...
        <div className="hidden sm:grid mt-16 pt-8 grid-cols-2 sm:grid-cols-4 gap-6 max-w-5xl mx-auto">
          <div className="flex flex-col items-center text-center gap-3 group">
            <div className="relative w-14 h-14 rounded-[1.25rem] bg-gradient-to-tr from-emerald-500 to-teal-400 flex items-center justify-center shrink-0 shadow-lg shadow-emerald-500/30 overflow-hidden group-hover:-translate-y-1 transition-transform duration-300">
              <div className="absolute inset-0 bg-slate-900/20 backdrop-blur-sm border border-slate-800/40 rounded-[1.25rem]"></div>
              <PhoneCall className="w-6 h-6 text-white relative z-10 stroke-[2.5]" />
            </div>
            <div>
              <h4 className="text-sm font-extrabold text-white tracking-tight">{phoneNumber}</h4>
          ...
          <div className="flex flex-col items-center text-center gap-3 group">
            ...
            <div>
              <h4 className="text-sm font-extrabold text-white tracking-tight">100% Free Service</h4>
          ...
          <div className="flex flex-col items-center text-center gap-3 group">
            ...
            <div>
              <h4 className="text-sm font-extrabold text-white tracking-tight">Mover Reward Cards</h4>
          ...
          <div className="flex flex-col items-center text-center gap-3 group">
            ...
            <div>
              <h4 className="text-sm font-extrabold text-white tracking-tight">Official Carrier Rates</h4>
